...
// mr:
// configurazione modificata in base a:
// https://www.thethingsnetwork.org/labs/story/program-your-lopy-from-the-arduino-ide-using-lmic/step/run-the-example#step-anchor
// abilitato:
