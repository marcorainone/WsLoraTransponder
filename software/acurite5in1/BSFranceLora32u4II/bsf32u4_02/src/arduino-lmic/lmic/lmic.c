...
// mr 27/07 vedere:
// https://www.thethingsnetwork.org/forum/t/lmics-tx-complete-event-takes-20-30-seconds-to-fire/2639/7
// LMiC purposely delays the TX_COMPLETE event to prevent the next transmission 
// to collide with a downlink that the node did not receive, 
// but the gateway is still busy sending (and therefor not in receive mode).
...
// ===================================================
// MR MOD 25/05: 
// SEND IMMEDIATELY MESSAGE WITHOUT DUTY CYCLE LIMIT
// define SEND_MSG_IMMEDIATELY if you want to start the lora tx overriding the lora EU limitations
#define SEND_MSG_IMMEDIATELY
// ===================================================
//
...
#ifdef SEND_MSG_IMMEDIATELY
				// -----------------------------
				// send msg now
				return now;
#else
				// original time to send msg
                return mintime;
				// -----------------------------
#endif
            }
